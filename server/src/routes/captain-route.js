...
router.put('/change-password', authMiddleware.authCaptain, captainController.changePassword)
router.delete('/delete-account', authMiddleware.authCaptain, captainController.deleteAccount)
